...
assert.match(source, /pathReferenceKeyboardAction\(event\.key, selection\)/);
assert.match(source, /action === PATH_REFERENCE_KEY_ACTION\.ENTER_DIRECTORY/);
assert.match(source, /action === PATH_REFERENCE_KEY_ACTION\.REFERENCE/);
