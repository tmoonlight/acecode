  ...
  return [
    {
      ...
      placement: 'right',
      title: '项目与历史',
      content: '这里可以切换项目、继续历史会话，也能进入 Skills 等扩展入口。',
    },
    {
      id: 'add-project',
      ...
      title: '添加项目',
      content: '点击文件夹“+”，选择已有的本地代码目录，它就会出现在左侧项目列表中。引导期间只做说明，不会真的打开目录选择器。',
    },
    {
      id: 'new-session',
      ...
      title: '新对话（开始新任务）',
      content: '顶部纸笔“+”会回到新对话首页，默认使用“无工作区”。它不会创建项目目录；要加入代码项目，请使用上一步的“添加项目”。',
    },
    {
      id: 'workspace',
