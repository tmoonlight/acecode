...
// installed <executable_dir>/../share/acecode/models_dev layout, then
// /usr/share/acecode/models_dev. Returns nullopt when none of the candidates
// point at an existing directory (caller should log a single WARN and continue).
//
