...
- [x] 2.9 Make compiled module-scope product metadata resolve lazily, remove the locale-switch document reload, preserve live WebUI state, and add an eager-translation regression gate
